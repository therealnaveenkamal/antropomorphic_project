...
class PlanarEndEffectorMover(object):
    ...
    def __init__(self, wait_reach_goal=True):
        ...
        print('PlanarEndEffectorMover start')
    ...
    def ee_pose_commands_clb(self, msg):
        ...
        res1 = calculate_ik(self.Pee_x, self.Pee_y, self.chi, DH_parameters, "plus", "plus")
        res2 = calculate_ik(self.Pee_x, self.Pee_y, self.chi, DH_parameters, "plus", "minus")
        res3 = calculate_ik(self.Pee_x, self.Pee_y, self.chi, DH_parameters, "minus", "plus")
        res4 = calculate_ik(self.Pee_x, self.Pee_y, self.chi, DH_parameters, "minus", "minus")
        result = []
        result.append(res1)
        result.append(res2)
        result.append(res3)
        ...
        for l, possible_solution in result:
